    ...
    while rclpy.ok():
        ...
        if ebot_controller.future.done():
            try:
                ...
                ebot_controller.vel.linear.x = ebot_controller.px * error_x
                ebot_controller.vel.linear.y = ebot_controller.py * error_y
                ebot_controller.vel.angular.z = ebot_controller.ptheta * error_theta
